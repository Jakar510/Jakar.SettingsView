...
namespace Jakar.SettingsView.iOS.Cells
{
	...
	public class ButtonCellView : CellBaseView
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:Jakar.SettingsView.iOS.Cells.ButtonCellView"/> class.
		/// </summary>
		...
		private void UpdateTitleAlignment() { TitleLabel.TextAlignment = _ButtonCell.TitleAlignment.ToUITextAlignment(); }
