...
namespace Jakar.SettingsView.iOS.Cells
{
	...
	public class LabelCellView : BaseCellView
	{
		...
		protected void UpdateValueText()
		{
			...
			if ( _ValueTextCell is null ) return; // for HotReload

			ValueLabel.Text = _ValueTextCell.ValueText;
		}
		...
		private void UpdateValueTextFont()
		{
			...
			var config = _ValueTextCell.ValueTextConfig;
		...
		private void UpdateValueTextColor()
		{
			...
			ValueLabel.TextColor = _ValueTextCell.ValueTextConfig.Color.ToUIColor();
		}
