...
#region constuctors
    ...
    public FormsViewContainer( Context context, IAttributeSet attributes ) : base(context, attributes) => Clickable = true;
    public FormsViewContainer( Context context, IAttributeSet attributes, int defStyleAttr ) : base(context, attributes, defStyleAttr) => Clickable = true;
    ...
    public FormsViewContainer( Context context, IAttributeSet attributes, Xamarin.Forms.View view ) : base(context, attributes)
    {
        Clickable = true;
        FormsView = view;
    }
    ...
    public FormsViewContainer( Context context, IAttributeSet attributes, CustomCell cell ) : base(context, attributes)
    {
        Clickable  = true;
        CustomCell = cell;
    }
