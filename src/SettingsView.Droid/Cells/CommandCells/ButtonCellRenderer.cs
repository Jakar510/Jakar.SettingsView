...
// using AButton = Android.Widget.ToggleButton;
...
namespace Jakar.SettingsView.Droid.Cells
{
	...
	public class ButtonCellView : BaseCell.BaseCellView, AView.IOnLongClickListener, AView.IOnClickListener // IBorderVisualElementRenderer
	{
		...
		{
			_Button.SetTextSize(ComplexUnitType.Sp, (float) _ButtonCell.TitleConfig.FontSize);
		...
		{
			_Button.SetTextColor(_ButtonCell.TitleConfig.Color.ToAndroid());
		...
		{
			_Button.SetBackgroundColor(_ButtonCell.GetButtonColor().ToAndroid());
			// AColor color = _ButtonCell.GetButtonColor().ToAndroid();
			// BackgroundColor.Color = color;
			// _Button.Background = CreateRippleDrawable(color);
			return true;
		}
		protected void UpdateTitleAlignment() { _Button.TextAlignment = _ButtonCell.TitleConfig.TextAlignment.ToAndroidTextAlignment(); }
