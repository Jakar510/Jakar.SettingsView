...
public class Section : TableSectionBase<Cell>
{
    ...
    public static readonly BindableProperty itemsSourceProperty =
        BindableProperty.Create(nameof(ItemsSource), typeof(IList), typeof(Section), default(IList?), BindingMode.OneWay, propertyChanged: ItemsChanged);

    public static readonly BindableProperty headerViewProperty =
        BindableProperty.Create(nameof(HeaderView), typeof(ISectionHeader), typeof(Section), new DefaultHeaderView(), propertyChanging: HeaderViewPropertyChanging);

    public static readonly BindableProperty footerViewProperty =
        BindableProperty.Create(nameof(FooterView), typeof(ISectionFooter), typeof(Section), new DefaultFooterView(), propertyChanging: FooterViewPropertyChanging);
    ...
    public static readonly BindableProperty titleProperty = BindableProperty.Create(nameof(Title),
                                                                                        ...
                                                                                        default(string?),
                                                                                        propertyChanging: ( BindableObject bindable, object? old_value, object? new_value ) =>
                                                                                                          {
    ...
    private int _templatedItemsCount;
    ...
    public Section( string       title ) : this() => this.Title = title;
    ...
    private void OnItemsSourceCollectionChanged( object sender, NotifyCollectionChangedEventArgs e )
    {
        switch ( e.Action )
        {
            ...
            {
                for ( int i = _templatedItemsCount - 1; i >= 0; i-- ) { RemoveAt(TemplateStartIndex + i); }
