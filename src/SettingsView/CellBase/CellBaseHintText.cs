...
namespace Jakar.SettingsView.Shared.CellBase
{
	public class HintTextCellBase : DescriptionCellBase
	{
		...
		public static readonly BindableProperty HintColorProperty = BindableProperty.Create(nameof(HintColor), typeof(Color), typeof(HintTextCellBase), Color.Default);
		public static readonly BindableProperty HintFontSizeProperty = BindableProperty.Create(nameof(HintFontSize), typeof(double), typeof(HintTextCellBase), -1.0d);
