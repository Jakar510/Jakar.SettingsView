...
public class FontConfig : IFontElement
{
    ...
    public void OnFontFamilyChanged( string oldValue, string newValue ) { throw new NotImplementedException(); }
    public void OnFontSizeChanged( double   oldValue, double newValue ) { throw new NotImplementedException(); }
    public double FontSizeDefaultValueCreator() => throw new NotImplementedException();
    public void OnFontAttributesChanged( FontAttributes oldValue, FontAttributes newValue ) { throw new NotImplementedException(); }
    public void OnFontChanged( Font                     oldValue, Font           newValue ) { throw new NotImplementedException(); }
}