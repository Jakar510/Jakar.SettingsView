...
namespace Jakar.SettingsView.Shared.Cells
{
	...
	public class CustomCell : CommandCell
	{
		...
		public static readonly BindableProperty LongCommandProperty = BindableProperty.Create(nameof(LongCommand), typeof(ICommand), typeof(CustomCell), default(ICommand));
		public static readonly BindableProperty ContentProperty = BindableProperty.Create(nameof(Content), typeof(View), typeof(CustomCell), default(View));
